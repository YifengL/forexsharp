...
namespace FXSharp.EA.NewsBox.Specs
{
    ...
    public class When_get_all_economic_event_for_today
    {
        ...
        public void Should_get_result_for_date()
        {
            ...
            IList<EconomicEvent> result = fxFactory.GetCriticalEventsForDateAsync(DateTime.Now.AddDays(2)).Result;
        }
        ...
        {
            var fxFactory = new ForexFactoryEconomicCalendar();
            IList<EconomicEvent> result = fxFactory.GetTodaysNextCriticalEventsAsync().Result;
        ...
        public void Should_merge_result_from_fxstreet_and_factory()
        {
            ...
            IList<EconomicEvent> result = ecoPools.AllResultsAsync().Result;
        }
    }
}