...
string System_NET_MQL_Common(string message[])
{
	...
	if(message[1] == "IsTradeContextBusy")
...
string System_NET_MQL_Trading(string message[])
{
	...
	return(OrderCloseReliable(StrToInteger(message[2]), StrToDouble(message[3]), StrToDouble(message[4]), StrToInteger(message[5]), StrToInteger(message[6])));
	...
	return(OrderModifyReliable(StrToInteger(message[2]),StrToDouble(message[3]), StrToDouble(message[4]),StrToDouble(message[5]), StrToTime(message[6])));
	...
	return(OrderSendReliable(message[2], StrToInteger(message[3]), StrToDouble(message[4]), StrToDouble(message[5]), StrToInteger(message[6]), StrToDouble(message[7]),StrToDouble(message[8]), StringTrimLeft(message[9]),StrToInteger(message[10]),StrToTime(message[11]),StrToInteger(message[12])));
