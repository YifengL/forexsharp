...
namespace TradePlatform.MT4.SDK.API
{
    ...
    public static class TechnicalIndicators
    {
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iAlligator(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int jaw_period,
                                        int jaw_shift, int teeth_period, int teeth_shift, int lips_period,
                                        int lips_shift, MA_METHOD ma_method, APPLY_PRICE appliedApplyPrice,
                                        GATOR_MODE mode, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iAlligator", symbol, ((int) timeframe), jaw_period, jaw_shift,
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iBullsPower(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int period,
                                         APPLY_PRICE appliedApplyPrice, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iBullsPower", symbol, ((int) timeframe), period,
                                                       ((int) appliedApplyPrice), shift);
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iCCI(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int period,
                                  APPLY_PRICE appliedApplyPrice, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iCCI", symbol, ((int) timeframe), period,
                                                       ((int) appliedApplyPrice), shift);
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iForce(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int period,
                                    MA_METHOD ma_method, APPLY_PRICE appliedApplyPrice, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iForce", symbol, ((int) timeframe), period, ((int) ma_method),
                                                       ((int) appliedApplyPrice), shift);
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iMomentum(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int period,
                                       APPLY_PRICE appliedApplyPrice, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iMomentum", symbol, ((int) timeframe), period,
                                                       ((int) appliedApplyPrice), shift);
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iMA(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int period, int ma_shift,
                                 MA_METHOD ma_method, APPLY_PRICE appliedApplyPrice, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iMA", symbol, ((int) timeframe), period, ma_shift,
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iMACD(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int fast_ema_period,
                                   int slow_ema_period, int signal_period, APPLY_PRICE appliedApplyPrice, MACD_MODE mode,
                                   int shift)
        {
            string retrunValue = handler.CallMqlMethod("iMACD", symbol, ((int) timeframe), fast_ema_period,
                                                       slow_ema_period, signal_period, ((int) appliedApplyPrice),
                                                       ((int) mode), shift);
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iOBV(this MqlHandler handler, string symbol, TIME_FRAME timeframe,
                                  APPLY_PRICE appliedApplyPrice, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iOBV", symbol, ((int) timeframe), ((int) appliedApplyPrice),
                                                       shift);
        ...
        /// <param name="shift"></param>
        /// <returns></returns>
        public static double iRSI(this MqlHandler handler, string symbol, TIME_FRAME timeframe, int period,
                                  APPLY_PRICE appliedApplyPrice, int shift)
        {
            string retrunValue = handler.CallMqlMethod("iRSI", symbol, ((int) timeframe), period,
                                                       ((int) appliedApplyPrice), shift);
